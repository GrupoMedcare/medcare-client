...
const Footer = () => {
  return (
    <footer className="bg-emerald-800 py-[4rem] mt-[16rem]">
      <div className="container-width grid max-lg:gap-[3rem] lg:grid-cols-4 items-start">
        <Link
          href={"/"}
        ...
        <div>
          ...
          <a className="" target="_blank" href="https://api.whatsapp.com/send/?phone=5591991242509&text=+&type=phone_number&app_absent=0">Whatsapp: (91) 991242509</a>
          </div>
        </div>
        <div>
          <span className="text-zinc-100 text-[1.8rem] font-semibold">
          ...
          <a href="" className="border-[1.3px] h-fit w-fit border-zinc-100 text-emerald-100 hover:bg-zinc-100 hover:text-emerald-800 p-[.65rem] rounded-full duration-300">
