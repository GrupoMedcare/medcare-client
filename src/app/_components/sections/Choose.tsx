...
const Choose = () => {
    return (
        <section className='mt-[16rem]'>
            <div className="container-width grid grid-cols-[.7fr_1fr] gap-[2rem]">
                <div className=''>
                    <Image className=' w-full h-[50rem] object-cover rounded-[1rem]' src={"https://images.unsplash.com/photo-1582750433449-648ed127bb54?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"} alt='Médica apontando para a direita' width={1000} height={1000} />
                </div>
                <div className='w-fit '>
                    ...
                    <div className='flex gap-[.5rem] mt-[1.2rem]'>
